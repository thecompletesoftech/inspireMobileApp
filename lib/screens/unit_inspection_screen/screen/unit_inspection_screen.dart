                  ...
                  child: ListView(
                    children: [
                                  ...
                                  if (controller.getUnitInspection()) {
                                    ...
                                    Get.toNamed(UnitInspectionSummary.routes,
                                        arguments: {
                                          ...
                                          "propertyDataModel":
                                              PropertyDataModel(
                                            id: controller.propertyDataModel.id,
                                            name: controller
                                                .propertyDataModel.name,
                                            address: '',
                                            city: controller
                                                .propertyDataModel.city,
                                            state: controller
                                                .propertyDataModel.state,
                                            zip: controller
                                                .propertyDataModel.zip,
                                            date:
                      ...
                      controller.isManually == true
                          ? Row(
                              ...
                              children: [
                                TitleheadMenu(
                                  ...
                                  value: controller.propertyInfo['name']
                                      .toString(),
                                ),
                                Row(
                                  children: [
                          ...
                          : CommonTextRow(
                              title: 'Property Name: ',
                              subTitle: controller.propertyDataModel.name ?? '',
                      ...
                      controller.isManually == true
                          ...
                          : CommonTextRow(
                              title: 'Property ID: ',
                              subTitle: '${controller.propertyDataModel.id}',
                          ...
                          ? Row(
                              ...
                              children: [
                                TitleheadMenu(
                                  ...
                                  value: controller.buildingInfo['name']
                                      .toString(),
                                ),
                                TitleheadMenu(
                                  title: Strings.buildingType,
                                  value:
                                      controller.buildingType.value.toString(),
                                ),
                              ],
                            ).paddingOnly(
                              left: 32.px, right: 32.px, bottom: 20.px)
                      ...
                      controller.isManually == true
                          ...
                          : CommonTextRow(
                              title: 'Building Type: ',
                              subTitle:
                                  '${controller.buildingsData.buildingType}',
                              imageString: icBuildings,
                            ).paddingOnly(
                              left: 32.px, right: 32.px, bottom: 40.px),
                    ],

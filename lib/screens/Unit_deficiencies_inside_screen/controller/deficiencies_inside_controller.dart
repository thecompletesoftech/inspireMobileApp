...
class UnitDeficienciesInsideController extends BaseController {
  String buildingName = '';
  String deficiencies = '';
                      ...
                      Text.rich(
                        TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text:
                                  'Visually determine if food storage space is present.\n',
                              style: MyTextStyle(
                                textColor: appColors.lightText,
                                textSize: 16.px,
                                textFamily: fontFamilyRegular,
                            ...
                            TextSpan(
                              text:
                                  'The presence of cold food storage should be evaluated under the ',
                              style: MyTextStyle(
                                textColor: appColors.lightText,
                                textSize: 16.px,
                                textFamily: fontFamilyRegular,

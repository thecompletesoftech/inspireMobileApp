...
class MainScreen extends GetView<MainController> {
  ...
  static const routes = "/MainScreen";
          ...
          child: SafeArea(
            child: Column(
              children: [
                ...
                ).paddingOnly(left: 32.px, right: 32.px, bottom: 18.px),
                Expanded(
                  flex: 1,
                              ...
                              childAspectRatio: Utils.isLandScapeMode(context)
                                  ? Utils.isSmallScreen(context)
                                      ...
                                      : Utils.isTabletScreen1(context)
                                          ...
                                          : ScalingQuery(context).verticalScale(0.63.px) //.....
                                  : Utils.isTabletScreen1(context)
                                      ? ScalingQuery(context).verticalScale(0.60.px) //pro mini

                        ...
                        children: [
                          Center(
                            child: MyTextView(
                              controller.isManually == true
                                  ...
                                  : '${controller.propertyDataModel.name}-${controller.buildingsData.buildingName} - ${controller.unitsData.unitName}',
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: TypeAheadField(
                                  controller:
                                      controller.generalPhysicalCondition,
                                  suggestionsCallback: (search) {
                                    controller.update();
                                    return controller
                                  ...
                                  builder: (context, c, focusNode) {
                                    return CommonTextField(
                                      ...
                                      shadowColor:
                                          controller.appColors.transparent,
                                      labelText:
                                          Strings.generalphysicalcondition,
                                    );
                                  },
                                  itemBuilder: (context, dynamic i) {
                                    return Column(
                          ...
                          controller.isManually == true
                              ...
                              : CommonTextRow(
                                  title: 'Property ID: ',
                                  subTitle:
                                      '${controller.propertyDataModel.id}',
                            ...
                            children: [
                              ...
                              CommonButton(
                                ...
                                textColor: controller.generalPhysicalCondition
                                    ...
                                    ? controller.appColors.black
                                    : controller.appColors.border1,
                                color: controller.generalPhysicalCondition.text
                                        .isNotEmpty
                                    ? controller.appColors.textPink
                                    : controller.appColors.black
                                        .withOpacity(0.11999999731779099),
